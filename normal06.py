...
t_names = [str(val.get_full_name) for val in t_list]
subj = [str(val.subject) for val in teachers]
print(student.get_full_name() + ' --> ' + student.get_class_room() + ' --> ' +
      ' '.join(t_names) + '--> ' + ' '.join(subj))
